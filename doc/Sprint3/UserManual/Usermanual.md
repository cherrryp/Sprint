...
> ![ภาพที่ 2](หน้าการเดินทางของฉัน.png) 
...
> ![ภาพที่ 3](หน้าฟอร์มรายงานปัญหาการเดินทาง.png) 
...
> ![ภาพที่ 4](หน้าประวัติการรายงาน.png)

> ![ภาพที่ 5](เพิ่มหลักฐาน.png) 
...
> ![ภาพที่ 6](หน้าReport_Management.png)

> ![ภาพที่ 7](หน้ารายงานทริป.png)

> ![ภาพที่ 8](หน้ารายละเอียดการรายงาน(แอดมิน).png) 

> ![ภาพที่ 9](หน้ารายละเอียดการรายงาน2(แอดมิน).png) 

> ![ภาพที่ 10](ภาพตัวอย่างการปิดเคส.png) 

หลังดำเนินการแล้ว สถานะในประวัติการรายงานจะเปลี่ยนตามผลการพิจารณา

> ![ภาพที่ 11](หน้าประวัติการรางาน2.png)
...
#### ประเภท Incidents ที่สามารถรายงาน

- **ACCIDENT** — อุบัติเหตุการจราจร เช่น การชนกัน การดีดตัวออกนอกเส้นทาง
- **VEHICLE_BREAKDOWN** — รถเสีย/ชำรุด เช่น เครื่องยนต์ดับ ยางแตก เบรกเสีย
- **MEDICAL_EMERGENCY** — เหตุฉุกเฉินด้านสุขภาพ เช่น ผู้โดยสารหมดลมหายใจ หัวใจวายกระทันหัน
- **NATURAL_DISASTER** — ภัยธรรมชาติ เช่น พายุ ฝนตกหนัก น้ำท่วม
- **CRIME_INCIDENT** — เหตุการณ์เกี่ยวกับอาชญากรรม เช่น การปล้น การปล่อย ความรุนแรง
- **OTHER** — เหตุการณ์อื่น ๆ ที่ไม่สามารถจำแนกได้

### ขั้นตอนการรายงาน Incidents

#### ขั้นตอนที่ 1: เข้าหน้าประวัติการเดินทาง

ผู้ขับขี่สามารถเข้าไปที่หน้า **My History** หรือรายการการเดินทางของตนเพื่อเลือกทริปที่เกิดปัญหา

> ![ภาพที่ 16](หน้าประวัติการเดินทางขับขี่.png)

#### ขั้นตอนที่ 2: คลิกปุ่มรายงาน Incident

จากรายการทริป จะมีปุ่ม **Report Incident** หรือ **แจ้งเหตุการณ์** ให้ผู้ขับขี่คลิก

> ![ภาพที่ 17](ปุ่มรายงาน_Incident.png)

#### ขั้นตอนที่ 3: เลือกประเภท Incident

เมื่อคลิกปุ่มรายงาน ระบบจะแสดงหน้าให้เลือกประเภทเหตุการณ์จากรายการข้างต้น

> ![ภาพที่ 18](เลือกประเภท_Incident.png)

#### ขั้นตอนที่ 4: กรอกแบบฟอร์ม Incident

ระบบจะแสดงแบบฟอร์มรายงาน Incident ให้สำหรับกรอกข้อมูลดังนี้:

1. **ประเภท Incident** — ต้องเลือกจากรายการประเภทข้างต้น
...
> ![ภาพที่ 19](แบบฟอร์ม_Incident_พร้อม_GoogleMaps.png)

#### ขั้นตอนที่ 5: ส่งรายงาน

หลังจากกรอกข้อมูลครบถ้วน ผู้ขับขี่สามารถกดปุ่ม **Submit Incident** หรือ **ส่งรายงาน** เพื่อส่งรายงาน

> ![ภาพที่ 20](ปุ่มส่งรายงาน_Incident.png)

#### ขั้นตอนที่ 6: ตรวจสอบสถานะรายงาน

ระบบจะแสดงสถานะรายงาน Incident ให้ผู้ขับขี่ติดตาม สามารถดูรายงานทั้งหมดในหน้า **Incident History** โดยจะแสดง:
- สถานะ (PENDING, UNDER_INVESTIGATION, RESOLVED, REJECTED)
- วันที่รายงาน
- หมายเหตุจากแอดมิน (หากมี)

> ![ภาพที่ 21](ประวัติ_Incident.png)

### การอัปโหลดหลักฐานเพิ่มเติม

ถ้า Incident ยังไม่ได้รับการแก้ไข ผู้ขับขี่สามารถเพิ่มหลักฐานเพิ่มเติมได้ โดยคลิกที่รายงาน Incident และกดปุ่ม **Add Evidence** เพื่อแนบรูปภาพหรือไฟล์เพิ่มเติม

> ![ภาพที่ 22](เพิ่มหลักฐาน_Incident.png)

### การจัดการ Incidents ฝั่งแอดมิน

#### หน้า Incidents Management

แอดมินสามารถเข้าไปดู Incidents ทั้งหมดในระบบได้จากเมนู **Incidents Management** (หรือ **Incident Dashboard**) ซึ่งเป็นส่วนที่แยกจาก Report Management ที่สำหรับรายงานพฤติกรรมผู้ใช้ หน้านี้จะแสดง:
- รายการ Incidents ทั้งหมดที่รายงานมา
- ชื่อและรหัสของผู้ขับขี่ที่รายงาน
- ประเภทของ Incident
- สถานะปัจจุบัน
- วันที่รายงาน

> ![ภาพที่ 23](หน้า_Incidents_Management_Admin.png)

#### การจัดการสถานะ Incident

แอดมินสามารถดำเนินการต่อ Incident ได้หลายวิธี:

**1. ดำเนินการตรวจสอบ** — เปลี่ยนสถานะจาก PENDING ไปเป็น UNDER_INVESTIGATION เพื่อแสดงว่าทำการสอบสวนแล้ว
...
> ![ภาพที่ 24](รายละเอียด_Incident_Admin_Section.png)

#### การติดตาม Incidents

แอดมินสามารถมองเห็นประวัติการจัดการ Incident ได้ เช่น:
- ใครเปลี่ยนสถานะเป็นอย่างไร
- เวลาที่เปลี่ยน
- หมายเหตุที่เพิ่มเข้ามา

> ![ภาพที่ 25](ประวัติการจัดการ_Incident.png)

### ข้อพึงระวังและคำแนะนำ

1. **รายงานโดยเร็ว** — ควรรายงาน Incident ทันทีที่เกิดขึ้น เพื่อให้ได้รับการช่วยเหลืออย่างรวดเร็ว
...
> ![ภาพที่ 16](หน้าการเดินทางของฉัน2.png) 
...
> ![ภาพที่ 17](แบบฟอร์มให้คะแนนและรีวิว.png) 
...
>  ![ภาพที่ 18](ภาพตัวอย่างส่งรีวิวสำเร็จ.png) 
...
> ![ภาพที่ 19](ภาพตัวอย่างรีวิวของผู้ขับขี่.png) 
...
> ![ภาพที่ 29](หน้าขอข้อมูลประวัติการใช้งาน.png) 
...
> ![ภาพที่ 30](หน้าจัดการคำขอฝั่งแอดมิน.png) 
...
> ![ภาพที่32](หน้าMonitor_ตารางAuditLoge.png) 

> ![ภาพที่ 33](หน้าMonitor_ตารางSystemLog.png) 

> ![ภาพที่ 34](หน้าMonitor_ตารางAccessLog.png) 
